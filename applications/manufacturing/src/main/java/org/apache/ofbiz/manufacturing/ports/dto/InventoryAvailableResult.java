...
/**
 * Minimal projection of the result returned by getProductInventoryAvailable
...
public final class InventoryAvailableResult {
    ...
    public InventoryAvailableResult(BigDecimal quantityOnHandTotal, BigDecimal availableToPromiseTotal) {
